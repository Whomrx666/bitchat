# Bitchat
![Bitchat preview](Bitchat.png)

## introduction
Bitchat is a tool used to chat anonymously using a WiFi network or hotspot to connect with one being a server and the other being a client.
...
- **second**: After that, you will be taken to the settings menu, namely the menu for selecting a theme and also configuring your username.
- **third**: After that, you will be faced with two choices: the person who first activates the tool will become the server or admin, then the other will become the client or user.
...
## Note!
user device must be on the same network such as wifi or hotspot to other devices.
